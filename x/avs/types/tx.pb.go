...
type AVSInfo struct {
	...
	AvsOwnerAddress []string `protobuf:"bytes,5,rep,name=avs_owner_address,json=avsOwnerAddress,proto3" json:"avs_owner_address,omitempty"`
	// asset_basic_info is all the basic asset information of the avs.
	AssetId []string `protobuf:"bytes,6,rep,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty"`
	// unbonding duration of avs.
	AvsUnbondingPeriod uint32 `protobuf:"varint,7,opt,name=avs_unbonding_period,json=avsUnbondingPeriod,proto3" json:"avs_unbonding_period,omitempty"`
	// the operator minimum delegation amount.
	MinSelfDelegation github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,8,opt,name=min_self_delegation,json=minSelfDelegation,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"min_self_delegation"`
	...
	OperatorAddress []string `protobuf:"bytes,10,rep,name=operator_address,json=operatorAddress,proto3" json:"operator_address,omitempty"`
	// Effective current epoch, accounting for current_epoch + 1
	// and current_epoch is the integer identifier of the epoch module
	StartingEpoch int64 `protobuf:"varint,11,opt,name=starting_epoch,json=startingEpoch,proto3" json:"starting_epoch,omitempty"`
}
...
var fileDescriptor_ef1ed06249b07d86 = []byte{
	...
	,
}
