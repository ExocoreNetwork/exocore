...
type AVSInfo struct {
	...
	// Effective current epoch, accounting for current_epoch + 1 and current_epoch is the integer identifier of the epoch module
	EffectiveCurrentEpoch int64 `protobuf:"varint,10,opt,name=effective_current_epoch,json=effectiveCurrentEpoch,proto3" json:"effective_current_epoch,omitempty"`
}
...
func (m *AVSInfo) GetEffectiveCurrentEpoch() int64 {
	if m != nil {
		return m.EffectiveCurrentEpoch
	}
	return 0
}
...
var fileDescriptor_c92b5dfe90086a66 = []byte{
	...
	,
}
...
func (m *AVSInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.EffectiveCurrentEpoch != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.EffectiveCurrentEpoch))
		i--
		dAtA[i] = 0x50
	}
...
func (m *AVSInfo) Size() (n int) {
	...
	if m.EffectiveCurrentEpoch != 0 {
		n += 1 + sovTx(uint64(m.EffectiveCurrentEpoch))
	}
	return n
}
...
func (m *AVSInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EffectiveCurrentEpoch", wireType)
			}
			m.EffectiveCurrentEpoch = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTx
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EffectiveCurrentEpoch |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
