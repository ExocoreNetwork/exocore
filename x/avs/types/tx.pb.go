...
type TaskInfo struct {
	...
	TaskResponseHash string `protobuf:"bytes,11,opt,name=task_response_hash,json=taskResponseHash,proto3" json:"task_response_hash,omitempty"`
	// task_response is the task response data.
	TaskResponse []byte `protobuf:"bytes,12,opt,name=task_response,json=taskResponse,proto3" json:"task_response,omitempty"`
	// bls_signature is the operator bls sig info.
	BlsSignature []byte `protobuf:"bytes,13,opt,name=bls_signature,json=blsSignature,proto3" json:"bls_signature,omitempty"`
	...
	ActualThreshold uint64 `protobuf:"varint,15,opt,name=actual_threshold,json=actualThreshold,proto3" json:"actual_threshold,omitempty"`
	// opt_in_count when creating a task, the actual opt-in operator counts at this moment
	OptInCount uint64 `protobuf:"varint,16,opt,name=opt_in_count,json=optInCount,proto3" json:"opt_in_count,omitempty"`
	// signed_count is Actual number of signatures already signed
	SignedCount uint64 `protobuf:"varint,17,opt,name=signed_count,json=signedCount,proto3" json:"signed_count,omitempty"`
	// no_signed_count is the final number of unsigned operators
	NoSignedCount uint64 `protobuf:"varint,18,opt,name=no_signed_count,json=noSignedCount,proto3" json:"no_signed_count,omitempty"`
	// err_signed_count is the number of operators with final incorrect signatures
	ErrSignedCount uint64 `protobuf:"varint,19,opt,name=err_signed_count,json=errSignedCount,proto3" json:"err_signed_count,omitempty"`
}
...
func (m *TaskInfo) GetOperatorAddress() string {
	if m != nil {
		return m.OperatorAddress
	}
	return ""
...
func (m *TaskInfo) GetTaskResponseHash() string {
	if m != nil {
...
func (m *TaskInfo) GetTaskResponse() []byte {
	if m != nil {
...
func (m *TaskInfo) GetBlsSignature() []byte {
	if m != nil {
...
func (m *TaskInfo) GetStage() string {
	if m != nil {
		return m.Stage
	}
	return ""
...
func (m *TaskInfo) GetOptInCount() uint64 {
	if m != nil {
		return m.OptInCount
	}
	return 0
...
func (m *TaskInfo) GetSignedCount() uint64 {
	if m != nil {
		return m.SignedCount
	}
	return 0
}

func (m *TaskInfo) GetNoSignedCount() uint64 {
	if m != nil {
		return m.NoSignedCount
	}
	return 0
}

func (m *TaskInfo) GetErrSignedCount() uint64 {
	if m != nil {
		return m.ErrSignedCount
	}
	return 0
}
...
type TaskResultInfo struct {
	...
	// actual_threshold is the Actual threshold
	ActualThreshold uint64 `protobuf:"varint,8,opt,name=actual_threshold,json=actualThreshold,proto3" json:"actual_threshold,omitempty"`
	// opt_in_count when creating a task, the actual opt-in operator counts at this moment
	OptInCount uint64 `protobuf:"varint,9,opt,name=opt_in_count,json=optInCount,proto3" json:"opt_in_count,omitempty"`
	// signed_count is Actual number of signatures already signed
	SignedCount uint64 `protobuf:"varint,10,opt,name=signed_count,json=signedCount,proto3" json:"signed_count,omitempty"`
	// no_signed_count is the final number of unsigned operators
	NoSignedCount uint64 `protobuf:"varint,11,opt,name=no_signed_count,json=noSignedCount,proto3" json:"no_signed_count,omitempty"`
	// err_signed_count is the number of operators with final incorrect signatures
	ErrSignedCount uint64 `protobuf:"varint,12,opt,name=err_signed_count,json=errSignedCount,proto3" json:"err_signed_count,omitempty"`
}
...
func (m *TaskResultInfo) GetActualThreshold() uint64 {
	if m != nil {
		return m.ActualThreshold
	}
	return 0
...
func (m *TaskResultInfo) GetOptInCount() uint64 {
	if m != nil {
		return m.OptInCount
	}
	return 0
...
func (m *TaskResultInfo) GetSignedCount() uint64 {
	if m != nil {
		return m.SignedCount
	}
	return 0
...
func (m *TaskResultInfo) GetNoSignedCount() uint64 {
	if m != nil {
		return m.NoSignedCount
	}
	return 0
...
func (m *TaskResultInfo) GetErrSignedCount() uint64 {
	if m != nil {
		return m.ErrSignedCount
	}
	return 0
...
var fileDescriptor_ef1ed06249b07d86 = []byte{
	...
	,
}
...
func (m *TaskInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ErrSignedCount != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.ErrSignedCount))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	}
	if m.NoSignedCount != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.NoSignedCount))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x90
	...
	if m.SignedCount != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.SignedCount))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
	...
	if m.OptInCount != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.OptInCount))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
...
func (m *TaskInfo) Size() (n int) {
	...
	if m.OptInCount != 0 {
		n += 2 + sovTx(uint64(m.OptInCount))
	}
	if m.SignedCount != 0 {
		n += 2 + sovTx(uint64(m.SignedCount))
	}
	if m.NoSignedCount != 0 {
		n += 2 + sovTx(uint64(m.NoSignedCount))
	}
	if m.ErrSignedCount != 0 {
		n += 2 + sovTx(uint64(m.ErrSignedCount))
	}
	return n
}
...
func (m *TaskResultInfo) Size() (n int) {
	...
	if m.OptInCount != 0 {
		n += 1 + sovTx(uint64(m.OptInCount))
	}
	if m.SignedCount != 0 {
		n += 1 + sovTx(uint64(m.SignedCount))
	}
	if m.NoSignedCount != 0 {
		n += 1 + sovTx(uint64(m.NoSignedCount))
	}
	if m.ErrSignedCount != 0 {
		n += 1 + sovTx(uint64(m.ErrSignedCount))
	}
	return n
}
...
func (m *TaskInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OptInCount", wireType)
			}
			m.OptInCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OptInCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignedCount", wireType)
			}
			m.SignedCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SignedCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NoSignedCount", wireType)
			}
			m.NoSignedCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NoSignedCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 19:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ErrSignedCount", wireType)
			}
			m.ErrSignedCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ErrSignedCount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
