...
type OperatorAllAssetsInfo struct {
	...
	AllAssetsState map[string]*OperatorAssetInfo `protobuf:"bytes,1,rep,name=all_assets_state,json=allAssetsState,proto3" json:"all_assets_state,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *OperatorAllAssetsInfo) GetAllAssetsState() map[string]*OperatorAssetInfo {
	if m != nil {
		return m.AllAssetsState
	}
	return nil
...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_adb6ebd423a2c426, []int{15}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_adb6ebd423a2c426, []int{16}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]*OperatorAssetInfo)(nil), "exocore.assets.v1.OperatorAllAssetsInfo.AllAssetsStateEntry")
...
var fileDescriptor_adb6ebd423a2c426 = []byte{
	...
	,
}
...
func (m *OperatorAllAssetsInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.AllAssetsState == nil {
				m.AllAssetsState = make(map[string]*OperatorAssetInfo)
			}
			var mapkey string
