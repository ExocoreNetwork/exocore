...
func (suite *GenesisTestSuite) TestValidateGenesis() {
	...
	testCases := []struct {
		...
		{
			name: "invalid genesis state due to invalid staker id",
			genState: &types.GenesisState{
				Operators: []types.OperatorInfo{
					{
						EarningsAddr: accAddress1.String(),
				...
				StakerRecords: []types.StakerRecord{
					{
						StakerID: "invalid",
					},
				},
		...
		{
			name: "invalid genesis state due to duplicate staker id",
			genState: &types.GenesisState{
				Operators: []types.OperatorInfo{
					{
						EarningsAddr: accAddress1.String(),
		...
		{
			name: "invalid genesis state due to invalid asset id",
			genState: &types.GenesisState{
				Operators: []types.OperatorInfo{
					{
						EarningsAddr: accAddress1.String(),
				...
				StakerRecords: []types.StakerRecord{
					{
						StakerID: "asd_0x64",
						StakerDetails: []types.StakerDetails{
							{
								AssetID: "",
							},
						},
		...
		{
			name: "invalid genesis state due to duplicate asset id",
			genState: &types.GenesisState{
				Operators: []types.OperatorInfo{
					{
						EarningsAddr: accAddress1.String(),
		...
		{
			name: "invalid genesis state due to invalid operator address",
			genState: &types.GenesisState{
				Operators: []types.OperatorInfo{
					{
						EarningsAddr: accAddress1.String(),
		...
		{
			name: "invalid genesis state due to unregsitered operator address",
			genState: &types.GenesisState{
				Operators: []types.OperatorInfo{
					{
						EarningsAddr: accAddress1.String(),
		...
		{
			name: "invalid genesis state due to negative amount",
			genState: &types.GenesisState{
				Operators: []types.OperatorInfo{
					{
						EarningsAddr: accAddress1.String(),
		...
		{
			name: "invalid genesis state due to nil amount",
			genState: &types.GenesisState{
				Operators: []types.OperatorInfo{
					{
						EarningsAddr: accAddress1.String(),
