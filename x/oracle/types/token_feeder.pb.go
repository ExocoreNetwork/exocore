...
// source: exocore/oracle/v1/token_feeder.proto
...
func (*NOMSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_cda9f9d49dac740c, []int{0}
}
...
func (m *RuleSource) Reset()         { *m = RuleSource{} }
func (m *RuleSource) String() string { return proto.CompactTextString(m) }
func (*RuleSource) ProtoMessage()    {}
func (*RuleSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_cda9f9d49dac740c, []int{1}
}
func (m *RuleSource) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RuleSource) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RuleSource.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RuleSource) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RuleSource.Merge(m, src)
}
func (m *RuleSource) XXX_Size() int {
	return m.Size()
}
func (m *RuleSource) XXX_DiscardUnknown() {
	xxx_messageInfo_RuleSource.DiscardUnknown(m)
}

var xxx_messageInfo_RuleSource proto.InternalMessageInfo

func (m *RuleSource) GetSourceIDs() []uint64 {
	if m != nil {
		return m.SourceIDs
	}
	return nil
...
func (m *RuleSource) GetNom() *NOMSource {
	if m != nil {
		return m.Nom
	}
	return nil
...
func (*TokenFeeder) Descriptor() ([]byte, []int) {
	return fileDescriptor_cda9f9d49dac740c, []int{2}
}
...
func init() {
	proto.RegisterType((*NOMSource)(nil), "exocore.oracle.v1.NOMSource")
	proto.RegisterType((*RuleSource)(nil), "exocore.oracle.v1.RuleSource")
	proto.RegisterType((*TokenFeeder)(nil), "exocore.oracle.v1.TokenFeeder")
}

func init() {
	proto.RegisterFile("exocore/oracle/v1/token_feeder.proto", fileDescriptor_cda9f9d49dac740c)
}

var fileDescriptor_cda9f9d49dac740c = []byte{
	// 404 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *RuleSource) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RuleSource) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RuleSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RuleSource) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RuleSource: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RuleSource: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
