...
type Prices struct {
	...
	NextRountId uint64                   `protobuf:"varint,2,opt,name=next_rount_id,json=nextRountId,proto3" json:"next_rount_id,omitempty"`
...
func (m *Prices) GetNextRountId() uint64 {
	if m != nil {
...
var fileDescriptor_50cc9ccc8f92b87a = []byte{
	...
	0xf3, 0x4a, 0x40, 0xf2, 0x4c, 0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0xdc, 0x20, 0xc1, 0x20, 0x90, 0x98,
	...
	0xc9, 0xcc, 0x4d, 0x75, 0xcc, 0x4b, 0x01, 0x69, 0x4e, 0x09, 0xe2, 0x04, 0x6b, 0xf4, 0xc9, 0x2c,
	0x2e, 0x71, 0xf2, 0x3a, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18,
	0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x86, 0x28, 0x83, 0xf4,
	0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x57, 0x88, 0xa9, 0x7e, 0xa9, 0x25,
	0xe5, 0xf9, 0x45, 0xd9, 0xfa, 0x30, 0xff, 0x55, 0xc0, 0x7c, 0x58, 0x52, 0x59, 0x90, 0x5a, 0x9c,
	0xc4, 0x06, 0xf6, 0xa2, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x4f, 0x26, 0xa8, 0xb4, 0x2d, 0x01,
	0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NextRountId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
