...
type BalanceChangeAction int32

const (
	// balance updated when a new round generated
	BalanceChangeAction_ACTION_ROUND_UNSPECIFIED BalanceChangeAction = 0
	// balance updated when a deposit happened
	BalanceChangeAction_ACTION_DEPOSIT BalanceChangeAction = 1
	// balance updated when a withdraw happened
	BalanceChangeAction_ACTION_WITHDRAW BalanceChangeAction = 2
	// balance updatd when a slah/refund on beacon chain happened
	BalanceChangeAction_ACTION_SLASH_REFUND BalanceChangeAction = 3
)

var BalanceChangeAction_name = map[int32]string{
...
var BalanceChangeAction_value = map[string]int32{
...
func (x BalanceChangeAction) String() string {
	return proto.EnumName(BalanceChangeAction_name, int32(x))
}

func (BalanceChangeAction) EnumDescriptor() ([]byte, []int) {
...
type BalanceInfo struct {
	...
	Change BalanceChangeAction `protobuf:"varint,5,opt,name=change,proto3,enum=exocore.oracle.v1.BalanceChangeAction" json:"change,omitempty"`
}
...
func (m *BalanceInfo) GetChange() BalanceChangeAction {
	if m != nil {
		return m.Change
	}
	return BalanceChangeAction_ACTION_ROUND_UNSPECIFIED
}
...
func init() {
	proto.RegisterEnum("exocore.oracle.v1.BalanceChangeAction", BalanceChangeAction_name, BalanceChangeAction_value)
...
var fileDescriptor_ed348d855b8fd9a8 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Change |= BalanceChangeAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
