...
// This function should be triggered by the governance in the future,and we need to move this function to the `assets` module to facilitate the query by other modules.
