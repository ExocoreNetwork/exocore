...
func init() {
	proto.RegisterType((*QueryStakerExCoreAddr)(nil), "exocore.deposit.v1.QueryStakerExCoreAddr")
	proto.RegisterType((*QueryStakerExCoreAddrResponse)(nil), "exocore.deposit.v1.QueryStakerExCoreAddrResponse")
}
...
var fileDescriptor_715f16e6b5833923 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	GetStakerExoCoreAddr(ctx context.Context, in *QueryStakerExCoreAddr, opts ...grpc.CallOption) (*QueryStakerExCoreAddrResponse, error)
}
...
func (c *queryClient) GetStakerExoCoreAddr(ctx context.Context, in *QueryStakerExCoreAddr, opts ...grpc.CallOption) (*QueryStakerExCoreAddrResponse, error) {
	out := new(QueryStakerExCoreAddrResponse)
	err := c.cc.Invoke(ctx, "/exocore.deposit.v1.Query/GetStakerExoCoreAddr", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	// Balance queries the balance of a single coin for a single account.
	GetStakerExoCoreAddr(context.Context, *QueryStakerExCoreAddr) (*QueryStakerExCoreAddrResponse, error)
}
...
func (*UnimplementedQueryServer) GetStakerExoCoreAddr(ctx context.Context, req *QueryStakerExCoreAddr) (*QueryStakerExCoreAddrResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStakerExoCoreAddr not implemented")
}
...
func _Query_GetStakerExoCoreAddr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryStakerExCoreAddr)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetStakerExoCoreAddr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/exocore.deposit.v1.Query/GetStakerExoCoreAddr",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetStakerExoCoreAddr(ctx, req.(*QueryStakerExCoreAddr))
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetStakerExoCoreAddr",
			Handler:    _Query_GetStakerExoCoreAddr_Handler,
		},
	},
