...
// GetDelegationStateByOperator get all assets state delegated to the specified operator
func (k Keeper) GetDelegationStateByOperator(ctx sdk.Context, operatorAddr string) (map[string]sdkmath.Int, error) {
