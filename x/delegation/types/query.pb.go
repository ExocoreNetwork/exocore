...
type UndelegationHoldCountReq struct {
	...
	RecordKey []byte `protobuf:"bytes,1,opt,name=record_key,json=recordKey,proto3" json:"record_key,omitempty"`
}
...
func (m *UndelegationHoldCountReq) GetRecordKey() []byte {
	if m != nil {
		return m.RecordKey
	}
	return nil
...
var fileDescriptor_aab345e1cf20490c = []byte{
	...
	,
}
...
func (m *UndelegationHoldCountReq) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.RecordKey = append(m.RecordKey[:0], dAtA[iNdEx:postIndex]...)
			if m.RecordKey == nil {
				m.RecordKey = []byte{}
			}
			iNdEx = postIndex
