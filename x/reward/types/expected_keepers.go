...
import (
	...
	exocore "github.com/exocore/x/chain/exported"
...
// Exocore provides Exocore functionality
type Exocore interface {
	GetChains(ctx sdk.Context) []exocore.Chain
	GetChainMaintainers(ctx sdk.Context, chain exocore.Chain) []sdk.ValAddress
	IsChainActivated(ctx sdk.Context, chain exocore.Chain) bool
}
