...
var _ types.UnpackInterfacesMessage = types2.GenesisState{}

// NewGenesisState - Create a new genesis state
func NewGenesisState(params Params, accounts GenesisAccounts) *types2.GenesisState {

}

// UnpackInterfaces implements UnpackInterfacesMessage.UnpackInterfaces
func (g types2.GenesisState) UnpackInterfaces(unpacker types.AnyUnpacker) error {
