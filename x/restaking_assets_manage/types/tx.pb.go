...
type AppChainInfo struct {
	...
	// exo_core_chain_index is the index of the chain in exocore, so far unused
	ExoCoreChainIndex uint64 `protobuf:"varint,4,opt,name=exo_core_chain_index,json=exoCoreChainIndex,proto3" json:"exo_core_chain_index,omitempty"`
}
...
type StakerSingleAssetOrChangeInfo struct {
	...
	// wait_unbonding_amount_or_want_change_value is the amount that is waiting for undelegation
	// or the amount by which it can change.
	WaitUnbondingAmountOrWantChangeValue github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=wait_unbonding_amount_or_want_change_value,json=waitUnbondingAmountOrWantChangeValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"wait_unbonding_amount_or_want_change_value"`
}
...
type OperatorSingleAssetOrChangeInfo struct {
	...
	// wait_unbonding_amount_or_want_change_value is the amount that is waiting for unbonding
	// or the amount by which it can change.
	WaitUnbondingAmountOrWantChangeValue github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=wait_unbonding_amount_or_want_change_value,json=waitUnbondingAmountOrWantChangeValue,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"wait_unbonding_amount_or_want_change_value"`
	// operator_own_wait_unbonding_amount is the amount that is owned by operator itself and waiting for unbonding
	// or the amount by which it can change
	OperatorOwnWaitUnbondingAmount github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=operator_own_wait_unbonding_amount,json=operatorOwnWaitUnbondingAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"operator_own_wait_unbonding_amount"`
	// operator_can_unbond_after_slash is the amount that is owned by operator itself and can be unbonded after slash
	// or the amount by which it can change
	OperatorCanUnbondAfterSlash github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,5,opt,name=operator_can_unbond_after_slash,json=operatorCanUnbondAfterSlash,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"operator_can_unbond_after_slash"`
}
...
func (*RegisterAssetReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_b24e66e530cc30d1, []int{13}
}
...
func (*RegisterAssetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b24e66e530cc30d1, []int{14}
}
...
var fileDescriptor_b24e66e530cc30d1 = []byte{
	...
	,
}
...
func (m *OperatorSingleAssetOrChangeInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.OperatorCanUnbondAfterSlash.Size()
		i -= size
		if _, err := m.OperatorCanUnbondAfterSlash.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintTx(dAtA, i, uint64(size))
	}
...
func (m *OperatorSingleAssetOrChangeInfo) Size() (n int) {
	...
	n += 1 + l + sovTx(uint64(l))
	l = m.OperatorCanUnbondAfterSlash.Size()
	n += 1 + l + sovTx(uint64(l))
	return n
}
...
func (m *OperatorSingleAssetOrChangeInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OperatorCanUnbondAfterSlash", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.OperatorCanUnbondAfterSlash.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
