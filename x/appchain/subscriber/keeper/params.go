...
// SetSubscriberParams sets the appchain subscriber parameters.
// The caller must ensure that the params are valid.
func (k Keeper) SetSubscriberParams(ctx sdk.Context, params commontypes.SubscriberParams) {
	store := ctx.KVStore(k.storeKey)
	bz := k.cdc.MustMarshal(&params)
	store.Set(types.ParamsKey(), bz)
}

// GetSubscriberParams gets the appchain subscriber parameters.
func (k Keeper) GetSubscriberParams(ctx sdk.Context) (res commontypes.SubscriberParams) {
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) SetCoordinatorFeePoolAddrStr(ctx sdk.Context, addrStr string) {
	...
	k.SetSubscriberParams(ctx, params)
}
...
func (k Keeper) GetDistributionTransmissionChannel(ctx sdk.Context) string {
	return k.GetSubscriberParams(ctx).DistributionTransmissionChannel
}
...
func (k Keeper) GetUnbondingPeriod(ctx sdk.Context) time.Duration {
	return k.GetSubscriberParams(ctx).UnbondingPeriod
}
