...
// source: exoslash/exoslash/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac25f141e0bece1f, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ac25f141e0bece1f, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "exoslash.exoslash.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "exoslash.exoslash.QueryParamsResponse")
}

func init() { proto.RegisterFile("exoslash/exoslash/query.proto", fileDescriptor_ac25f141e0bece1f) }

var fileDescriptor_ac25f141e0bece1f = []byte{
	// 279 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x4d, 0xad, 0xc8, 0x2f,
	0xce, 0x49, 0x2c, 0xce, 0xd0, 0x87, 0x33, 0x0a, 0x4b, 0x53, 0x8b, 0x2a, 0xf5, 0x0a, 0x8a, 0xf2,
	...
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xe1, 0x64, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xa0,
	0x5d, 0x58, 0xbb, 0xdb, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/exoslash.exoslash.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/exoslash.exoslash.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "exoslash.exoslash.Query",
	...
	Metadata: "exoslash/exoslash/query.proto",
}
