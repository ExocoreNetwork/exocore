...
var fileDescriptor_fb88546bd6602038 = []byte{
	...
	0x88, 0x03, 0xa4, 0x14, 0x24, 0x64, 0x34, 0x83, 0x91, 0x8b, 0x35, 0x10, 0xe4, 0x0b, 0xa1, 0x3e,
	0x46, 0x2e, 0x01, 0x30, 0x0b, 0xc9, 0x60, 0x21, 0x55, 0x3d, 0x4c, 0x5f, 0xe9, 0x61, 0x58, 0x2e,
	0xa5, 0x82, 0x4d, 0x19, 0x48, 0x81, 0x73, 0x7e, 0x5e, 0x49, 0x51, 0x62, 0x72, 0x09, 0x48, 0xa1,
	0x92, 0x6e, 0xd3, 0xe5, 0x27, 0x93, 0x99, 0xd4, 0x85, 0x54, 0xf5, 0xb1, 0xf8, 0x1d, 0xc3, 0x50,
	...
	0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x77, 0x85, 0x18, 0xe5, 0x97, 0x5a, 0x52, 0x9e,
	0x5f, 0x94, 0x0d, 0x37, 0xb9, 0x02, 0x6e, 0x76, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x38,
	0xe8, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xe0, 0x0f, 0x2d, 0x94, 0xc6, 0x01, 0x00, 0x00,
}
...
type QueryClient interface {
	...
	QueryAVSTaskInfo(ctx context.Context, in *GetAVSTaskInfoReq, opts ...grpc.CallOption) (*TaskContractInfo, error)
}
...
func (c *queryClient) QueryAVSTaskInfo(ctx context.Context, in *GetAVSTaskInfoReq, opts ...grpc.CallOption) (*TaskContractInfo, error) {
	out := new(TaskContractInfo)
	err := c.cc.Invoke(ctx, "/exocore.avstask.v1.Query/QueryAVSTaskInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	// TaskInfo queries the task information.
	QueryAVSTaskInfo(context.Context, *GetAVSTaskInfoReq) (*TaskContractInfo, error)
}
...
func (*UnimplementedQueryServer) QueryAVSTaskInfo(ctx context.Context, req *GetAVSTaskInfoReq) (*TaskContractInfo, error) {
...
func _Query_QueryAVSTaskInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/exocore.avstask.v1.Query/QueryAVSTaskInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).QueryAVSTaskInfo(ctx, req.(*GetAVSTaskInfoReq))
	}
